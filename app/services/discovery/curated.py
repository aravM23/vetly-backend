...
CURATED_CREATORS: list[dict] = [
    # ── Anchor list (Jonathan's Stanley Ambassador anchors) ──────────────
    {
        ...
        "programs": ["club_stanley"],  # 112K → over Ambassador 100K cap
    },
    {
        "handle": "kimcoles",
    ...
    # ── High-confidence content-business operators ───────────────────────
    {
        ...
        "why_known": "Runs InstaGrowth Boss; flagship content-business educator with multi-year track record. Confirmed perfect fit by Stanley team.",
    ...
    },
    {
        ...
        "why_known": "Online Marketing Made Easy podcast; Digital Course Academy. Foundational Creator-economy educator.",
    ...
    },
    {
        ...
        "why_known": "Think Media founder; flagship video-Creator education channel with cross-platform audience.",
